...
export type IncrementTrackViewsMutation = {
  __typename?: "Mutation";
  incrementTrackViews: {
    __typename?: "IncrementTrackViewsResponse";
    code: number;
...
export type GetTracksQuery = {
  ...
  tracksForHome: Array<{
    ...
    length?: number | null;
    modulesCount?: number | null;
    author: { __typename?: "Author"; name: string; photo?: string | null };
  }>;
};

export const IncrementTrackViewsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "IncrementTrackViews" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "incrementTrackViewsId" },
          },
          type: {
            kind: "NonNullType",
